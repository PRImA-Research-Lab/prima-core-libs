 ...
 */
public class SeparatorRegion extends RegionImpl {

	public SeparatorRegion(IdRegister idRegister, ContentFactory contentFactory, RegionType type, Id id,
	...
	public String getColour() {
		return ((StringValue)getAttributes().get(DefaultXmlNames.ATTR_colour).getValue()).val;
	}

	public void setColour(String colour) {
		try {
			getAttributes().get(DefaultXmlNames.ATTR_colour).setValue(VariableValue.createValueObject(colour));
