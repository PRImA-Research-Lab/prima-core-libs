 ...
 */
public class LineDrawingRegion extends RegionImpl {

	public LineDrawingRegion(IdRegister idRegister, ContentFactory contentFactory, RegionType type, Id id,
	...
	public String getPenColour() {
		return ((StringValue)getAttributes().get(DefaultXmlNames.ATTR_penColour).getValue()).val;
	}

	public void setPenColour(String colour) {
		try {
			getAttributes().get(DefaultXmlNames.ATTR_penColour).setValue(VariableValue.createValueObject(colour));
